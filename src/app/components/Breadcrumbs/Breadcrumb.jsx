        ...
        <div>
            <nav aria-label="Breadcrumb">
                <ol className="flex items-center gap-1 text-sm text-gray-600">
                    <li>
                        <a href="#" className="block transition  text-white  hover:text-gray-700">
                    ...
                    <li>
                        <a href="#" className={`block transition  text-white hover:text-gray-700 ${cairo200.className}`}> لوحة التحكم </a>
                    </li>
