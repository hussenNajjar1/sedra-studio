        ...
        <div className=''>
            ...
            <footer className="footer footer-center    flex flex-col items-center space-y-8 justify-center p-10 bg-base-200 text-base-content rounded   bg-sky-800">
                ...
                <nav className="grid grid-flow-col gap-4">
                    ...
                    <div className='flex  space-x-3'>
                        <Link href={`https://wa.me/352681520601`} className={`link link-hover ${cairo100.className}` } aria-label={'انتقال الى واتساب'}  > واتساب  </Link>
                        <Link href={`https://wa.me/352681520601`} aria-label={'انتقال الى واتساب'} ><FaWhatsapp /></Link>
                    </div>
                    <div className='flex  space-x-3'>
